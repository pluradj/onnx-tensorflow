...
modelzoo_report(models_dir='models', output_dir='/tmp', include=None,
...
class Results:
  ...
  def append_detail(self, line):
    """Appends a line of detailed status."""
  ...
  def summary(self):
    """Returns report summary (counts, report location) as a string."""
...
def _configure_env():
  # additional configuration based on environment variables
...
def modelzoo_report(models_dir='models',
                    ...
                    verbose=False,
                    dry_run=False):
  """Generates a testing report for the models found in the given directory.
